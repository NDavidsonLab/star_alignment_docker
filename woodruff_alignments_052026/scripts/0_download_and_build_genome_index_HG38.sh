...
(
    ...
    [ -f gencode.v48.transcripts.fa.gz ] || \
        wget ftp://ftp.ebi.ac.uk/pub/databases/gencode/Gencode_human/release_48/gencode.v48.transcripts.fa.gz
    ...
    gunzip -c gencode.v48.transcripts.fa.gz > gencode.v48.transcripts.fa
